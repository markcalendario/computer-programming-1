...
int main()
{
    ...
    // Loop if the user inputs other diameter and price than the required:
    // (10, 12, 14)
    // (178, 259, 314)
    ...
    printf("Our least expensive pizza is %d-inch pizza that costs 2.04 per square inch ", diameterC);
